...
<main class="flex-1 overflow-y-auto p-5">
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="add_user.php?role=donor" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-150 ease-in-out">
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="donor-list">
                    ...
                    <tr class="donor-row">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="view_donor.php?id=<?php echo $row['id']; ?>" class="text-green-600 hover:text-green-900 mr-3">View</a>
                            <a href="edit_user.php?id=<?php echo $row['id']; ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                            <a href="../cashier/send_email.php?donor_id=<?php echo $row['id']; ?>" class="text-blue-600 hover:text-blue-900 mr-3">
                            ...
                            <a href="#" class="text-red-600 hover:text-red-900" 
                               onclick="return confirm('Are you sure you want to delete this donor?') ? window.location.href='delete_user.php?id=<?php echo $row['id']; ?>' : false;">
                                Delete
                            </a>
                        </td>
                    </tr>
